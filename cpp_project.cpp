...
{
private:
    int account_no[10];  // int array of all account numbers
    string password[10]; // string array for all passwords
    string name[10];     // string array for all names
    string mobile[10];   // string array for all mobile numbers
    int balance[10];     // int array for all account's balances
    int dob[10];         // string array for all DOBs
